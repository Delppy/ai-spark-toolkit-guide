...
const Business = () => {
  ...
  return (
    <>
      <SEOHead 
        title="AI Tools for Business & Enterprise"
        description="Boost productivity and efficiency with AI tools designed for business professionals, entrepreneurs, and enterprises."
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Accelerate your business growth with AI-powered solutions for automation, analytics, and strategic decision-making.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div className="text-muted-foreground">
              Showing {totalResults} business tools
            </div>
            <ToolSorting
              sort={sort}
          ...
          {filteredAndSortedTools.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-muted-foreground mb-2">No business tools found</h3>
            </div>
          ) : (
