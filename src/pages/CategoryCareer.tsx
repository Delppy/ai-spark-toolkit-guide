    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-green-50">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-bold text-slate-900">Career Development</h1>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-green-900 to-blue-900 bg-clip-text text-transparent">
            AI Tools for Your Career
          </h2>
          <p className="text-lg text-slate-600 max-w-2xl mx-auto">
            Advance your career with AI-powered tools for job searching, resume building, interview prep, and skill development. Land your dream job!
          </p>
        </div>
      ...
      <section className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-2xl font-bold text-slate-900">Career AI Tools</h3>
        </div>
      ...
      {/* Prompt Packs */}
      <section className="container mx-auto px-4 py-8">
        <h3 className="text-2xl font-bold mb-6 text-slate-900">Career Prompt Packs</h3>
