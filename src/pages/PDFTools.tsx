...
const PDFTools = () => {
  ...
  return (
    <>
      <SEOHead 
        title="AI Tools for PDF Processing"
        description="Work smarter with PDF files using AI-powered tools for editing, conversion, analysis, and document processing."
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Streamline your document workflow with AI-powered PDF tools for editing, conversion, analysis, and intelligent processing.
            </p>
          </div>
          ...
          <div className="mb-6">
            <div className="relative max-w-2xl mx-auto">
              ...
              <Input
                placeholder="Search PDF processing tools..."
                value={searchTerm}
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <div className="text-muted-foreground">
              Showing {totalResults} PDF tools
            </div>
            <ToolSorting
              sort={sort}
          ...
          {filteredAndSortedTools.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-muted-foreground mb-2">No PDF tools found</h3>
            </div>
          ) : (
